function Read-{{ friendly_name }}Configuration {
    <#
    .SYNOPSIS
    ...
    Try {
        ...
        Write-Log -Message "Unable to deserialize saved configuration from json. Please use Remove-{{ module_name }}Configuration to remove the saved configuration."
    }
}