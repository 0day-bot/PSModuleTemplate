...
Set-Variable -Name {{ module_name }} -Value @{ ConfPath = [System.IO.Path]::Combine([Environment]::GetFolderPath("LocalApplicationData"),"{{ module_name }}","config.json") } -Scope Script